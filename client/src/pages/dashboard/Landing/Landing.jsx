  ...
  return (
    <Container fluid className="ascendio-landing-containerPrincipal">
      <main className="ascendio-landing-main row">
        {" "}
        <div className="col-xl-6 ascendio-landing-main-hijo">
          <img
        ...
        <div className="ascendio-landing-main-hijo2 col-xl-6">
          <div className="ascendio-landing-textos-padre row">
            <div className=" col-xl-3 ascendio-landing-textos-hijo">
              <img
        ...
        <div className="ascendio-landing-main-hijo col-xl-6">
          <TradingViewWidget />
        </div>
      </main>
